...
export class SubcontractorComponent implements AfterViewInit, OnDestroy {
    ...
    constructor(
        ...
        this.form = new FormGroup({
            type: new FormControl('subcontractor'),
            name_of_agency: new FormControl('', [Validators.required, Validators.minLength(2), Validators.maxLength(50)]),
