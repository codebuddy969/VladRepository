...
export class PartnershipComponent implements AfterViewInit, OnDestroy {
    ...
    constructor(
        ...
        this.form = new FormGroup({
            type: new FormControl('partnership'),
            ...
            referred_company: new FormControl('', [Validators.required, Validators.minLength(2), Validators.maxLength(50)]),
            occupation: new FormControl('', [Validators.required, Validators.minLength(2), Validators.maxLength(50)]),
            contact_person: new FormControl('', [Validators.required, Validators.minLength(2), Validators.maxLength(50)]),
            email: new FormControl('', [Validators.required, CustomValidators.validateEmail]),
            email_contact_pers: new FormControl('', [Validators.required, CustomValidators.validateEmail]),
            phone: new FormControl('', [Validators.required, CustomValidators.validatePhone]),
            phone_contact_pers: new FormControl('', [Validators.required, CustomValidators.validatePhone]),
